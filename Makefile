OBJECTS= ./build/compiler.o ./build/lexer.o ./build/node.o ./build/token.o ./build/expressionable.o ./build/parser.o ./build/lex_process.o ./build/cprocess.o ./build/helpers/buffer.o ./build/helpers/vector.o
INCLUDES= -I./
